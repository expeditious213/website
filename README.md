...
<head>
  ...
  <meta name="generator" content="Expeditious Auto Repair WEBSITE v1.0">
  <meta name="description" content="Construction Html5 Template">
  <title>Expeditious Auto Repair</title>
 ...
 <div class="body-inner">
    ...
    <div class="row">
     ...
     <div class="col-lg-8 col-md-8">
      ...
      <ul class="top-info text-center text-md-left">
       ...
       <li><i class="fas fa-map-marker-alt"></i> <p class="info-text">4534 Baldwin Avenue
        El Monte, CA 91731
        USA</p></li>
  ...
  <ul class="list-unstyled">
    ...
    <li data-aos="fade-right" data-aos-delay="500" data-aos-duration="1200">
      ...
      <a title="Yelp" href="https://www.yelp.com/biz/garcias-construction-los-angeles" target="_blank">
      ...
      <div class="container">
        <div class="logo-area">
          <div class="row align-items-center">
            <div class="logo col-lg-3 text-center text-lg-left mb-3 mb-md-5 mb-lg-0"><a class="d-block" href="index.html"><img alt="Constra" loading="lazy" src="images/logo.png" /> </a></div>
    ...
    <li data-aos="fade-left" data-aos-delay="600" data-aos-duration="1200">
      ...
      <div class="info-box">
        ...
        <div class="info-box-content">
          ...
          <p class="info-box-subtitle">(626) 758-1168</p>
    ...
    <li data-aos="fade-left" data-aos-delay="800" data-aos-duration="1200">
      ...
      <div class="info-box">
        ...
        <div class="info-box-content">
          ...
          <p class="info-box-title">Professional Auto Care</p>

          <p class="info-box-subtitle">Request a Consultation</p>
    ...
    <li data-aos="fade-left" data-aos-delay="1000" data-aos-duration="1200" class="last">
      ...
      <div class="info-box last">
        ...
        <div class="info-box-content">
          ...
          <p class="info-box-title">General Auto Diagnosis</p>

          <p class="info-box-subtitle">Contact Our Garage</p>
...
<div class="banner-carousel-item" style="background-image:url(https://i.ibb.co/Z6HZ0C5/bg1.jpg)">
<div class="slider-content">
<div class="container h-100">
<div class="row align-items-center h-100">
<div class="col-md-12 text-center">
<h2 class="slide-title" data-animation-in="slideInLeft"> </h2>
<h3 class="slide-sub-title" data-animation-in="slideInRight">Certified and Experienced</h3>
<p data-animation-in="slideInLeft" data-duration-in="1.2">
<a href="projects-single.html" class="slider btn btn-primary">Get Expert Advice</a>
<a href="contact.html" class="slider btn btn-primary border">Drive In Today</a>
</p>
</div>
</div>
</div>
...
<div class="banner-carousel-item" style="background-image:url(https://i.ibb.co/1sz13Gn/bg2.jpg)">
<div class="slider-content text-left">
<div class="container h-100">
<div class="row align-items-center h-100">
<div class="col-md-12">
<h2 class="slide-title-box" data-animation-in="slideInDown">Professional Auto Care</h2>
...
<div class="row align-items-center h-100">
<div class="col-md-12">
<h3 class="slide-sub-title" data-animation-in="fadeIn">Rated 4.5 Stars on Yelp</h3>
<p class="slider-description lead" data-animation-in="slideInRight">Your Trusted LA Auto Experts</p>
<div data-animation-in="slideInLeft">
<a href="contact.html" class="slider btn btn-primary" aria-label="contact-with-us">Ask a Mechanic</a>
<a href="about.html" class="slider btn btn-primary border" aria-label="learn-more-about-us">Talk to a Tech</a>
</div>
</div>
</div>
</div>
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="copyright-info">
                    <span>&copy; <script>document.write(new Date().getFullYear());</script>, H&A Quality Plastering, Los Angeles, CA 90012</span>
                </div>
            </div>
